                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('situation_professionnelle') is-invalid @enderror" 
                                    ...
                                    <option value="CDI" {{ old('situation_professionnelle') == 'CDI' ? 'selected' : '' }}>CDI</option>
                                    <option value="CDD" {{ old('situation_professionnelle') == 'CDD' ? 'selected' : '' }}>CDD</option>
                                    <option value="Indépendant" {{ old('situation_professionnelle') == 'Indépendant' ? 'selected' : '' }}>Indépendant</option>
                                    <option value="Retraité" {{ old('situation_professionnelle') == 'Retraité' ? 'selected' : '' }}>Retraité</option>
                                    <option value="Sans emploi" {{ old('situation_professionnelle') == 'Sans emploi' ? 'selected' : '' }}>Sans emploi</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" 
                                       ...
                                       id="revenus_mensuels" name="revenus_mensuels" value="{{ old('revenus_mensuels') }}">

<header class="main-header">
    <div class="header-left">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="logo-link">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Banque Populaire" class="logo-img">
        </a>
    </div>
        ...
        <div class="dropdown">
            <button class="btn btn-link dropdown-toggle" type="button" data-bs-toggle="dropdown">
                ...
                <?php if($notificationsCount > 0): ?>
                    <span class="badge bg-danger"><?php echo e($notificationsCount); ?></span>
                <?php endif; ?>
            </button>
        </div>
        ...
        <div class="dropdown">
            <button class="btn btn-link dropdown-toggle" type="button" data-bs-toggle="dropdown">
                <div class="user-avatar">
                    <?php echo e(substr(auth()->user()->nom, 0, 1)); ?>
...
</script><?php /**PATH C:\xampp\htdocs\gestion-bancaire\resources\views/partials/header.blade.php ENDPATH**/ ?>
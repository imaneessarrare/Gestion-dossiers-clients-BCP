    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h3">Créer un nouveau client</h1>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="date_naissance" name="date_naissance" value="<?php echo e(old('date_naissance')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="cin" name="cin" value="<?php echo e(old('cin')); ?>" required>
                                <?php $__errorArgs = ['cin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" 
                                      id="adresse" name="adresse" rows="2"><?php echo e(old('adresse')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="CDI" <?php echo e(old('situation_professionnelle') == 'CDI' ? 'selected' : ''); ?>>CDI</option>
                                    <option value="CDD" <?php echo e(old('situation_professionnelle') == 'CDD' ? 'selected' : ''); ?>>CDD</option>
                                    <option value="Indépendant" <?php echo e(old('situation_professionnelle') == 'Indépendant' ? 'selected' : ''); ?>>Indépendant</option>
                                    <option value="Retraité" <?php echo e(old('situation_professionnelle') == 'Retraité' ? 'selected' : ''); ?>>Retraité</option>
                                    <option value="Sans emploi" <?php echo e(old('situation_professionnelle') == 'Sans emploi' ? 'selected' : ''); ?>>Sans emploi</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="revenus_mensuels" name="revenus_mensuels" value="<?php echo e(old('revenus_mensuels')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gestion-bancaire\resources\views/clients/create.blade.php ENDPATH**/ ?>